...
class BenchmarkRunner:
    ...
    def run_benchmark(self, func: Callable, name: str = None, *args, **kwargs) -> BenchmarkResult:
        """
        运行基准测试
    ...
    def run_benchmark_suite(
        self, benchmarks: List[Tuple[Callable, str, tuple, dict]], name: str = "基准测试套件"
    ...
    def _calculate_statistics(
        self, times: List[float], memories: List[int], cpus: List[float]
    ) -> Dict[str, Any]:
        """计算统计信息"""
        stats = {}
    ...
    def compare_results(
        self, result1: BenchmarkResult, result2: BenchmarkResult, metric: str = "time_mean"
    ) -> Dict[str, Any]:
        """
        比较两个基准测试结果
