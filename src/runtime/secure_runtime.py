    ...
    def execute(self, code: str, validate: bool = True) -> Tuple[bool, Optional[Any], Optional[str]]:
        ...
        try:
            ...
            if hasattr(result, 'errors') and result.errors:
                errors = result.errors if isinstance(result.errors, (list, tuple)) else [result.errors]
...
def execute_safely(code: str, allowed_modules: Optional[Set[str]] = None) -> Tuple[bool, Optional[Any], Optional[str]]:
    """安全执行代码
