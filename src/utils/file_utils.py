...
def write_json_file(filepath: Union[str, Path], 
                   data: Any, 
                   indent: int = 2, 
                   default=str,
...
def write_yaml_file(filepath: Union[str, Path], 
                   data: Any, 
...
def copy_file_with_backup(src: Union[str, Path], 
                         dst: Union[str, Path],
...
def read_file_lines(filepath: Union[str, Path], 
...
def write_file_lines(filepath: Union[str, Path], 
                    lines: List[str],
                    encoding: str = 'utf-8') -> None:
    """
    写入文件行
