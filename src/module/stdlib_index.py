...
STDLIB_MODULES = {
    ...
    "数据类型": {
        ...
        "待实现": ["array", "weakref", "types", "copy", "pprint", "reprlib", "enum", "graphlib", "dataclasses", "contextlib", "abc", "numbers", "typing"],
        "说明": "高级数据结构、类型系统"
    },
    ...
    "文件格式": {
        "已实现": [],
        "待实现": ["csv", "configparser", "netrc", "toml"],
        "说明": "特定文件格式处理"
    },
    
    "加密服务": {
        "已实现": [],
        "待实现": ["hashlib", "hmac", "secrets"],
        "说明": "加密和安全"
    },
    ...
    "并发执行": {
        "已实现": [],
        "待实现": ["threading", "multiprocessing", "concurrent", "asyncio", "queue", "sched", "subprocess"],
        "说明": "多线程、多进程、异步"
    },
    ...
    "互联网协议和支持": {
        "已实现": [],
        "待实现": ["webbrowser", "cgi", "cgitb", "wsgiref", "urllib", "http", "ftplib", "poplib", "imaplib", "nntplib", "smtplib", "smtpd", "telnetlib", "uuid", "socketserver", "xmlrpc"],
        "说明": "网络协议"
    },
    ...
    "程序框架": {
        "已实现": [],
        "待实现": ["turtle", "cmd", "shlex"],
        "说明": "程序框架"
    },
    
    "图形用户界面": {
        "已实现": [],
        "待实现": ["tkinter", "tkinter.ttk", "tkinter.scrolledtext", "tkinter.colorchooser", "tkinter.filedialog", "tkinter.font", "tkinter.messagebox", "tkinter.simpledialog"],
        "说明": "GUI编程"
    },
    
    "开发工具": {
        "已实现": [],
        "待实现": ["typing", "pydoc", "doctest", "unittest", "unittest.mock", "trace", "traceback", "gc", "inspect", "dis", "pickletools", "code", "codeop", "profile", "cProfile", "pstats", "timeit", "bdb", "faulthandler"],
        "说明": "开发、测试、调试"
    },
