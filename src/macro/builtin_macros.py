...
def register_builtin_macros(macro_system):
    ...
    # 遍历宏：遍历列表中的每个元素
    macro_system.register("遍历", Macro(
        name="遍历",
    ...
    # 重复宏：重复执行指定次数
    macro_system.register("重复", Macro(
        name="重复",
        type=MacroType.SYNTAX,
        params=["次数", "循环体"],
    ...
    # 持续宏：持续执行（无限循环）
    macro_system.register("持续", Macro(
        name="持续",
        type=MacroType.SYNTAX,
        params=["循环体"],
        body="若真：循环体。持续：循环体。",
    ...
    # 除非宏：除非条件成立，否则执行动作
    macro_system.register("除非", Macro(
        name="除非",
        type=MacroType.SYNTAX,
        params=["条件", "动作"],
        body="若非(条件)：动作。",
    ...
    # 断言宏：断言条件为真
    macro_system.register("断言", Macro(
        name="断言",
        type=MacroType.SYNTAX,
        params=["条件", "消息"],
        body="若非条件：印消息。抛出异常。",
    ...
    # 调试宏：打印调试信息
    macro_system.register("调试", Macro(
        name="调试",
        type=MacroType.SYNTAX,
        params=["表达式"],
        body="印\"调试: 表达式 = \"。印表达式。",
    ...
    # 计时宏：测量执行时间
    macro_system.register("计时", Macro(
        name="计时",
        type=MacroType.SYNTAX,
        params=["代码块"],
