...
from src.parser.ast_nodes import (
    ...
    BinaryOpNode, UnaryOpNode, AssignNode, VarDefNode,
    IfNode, ForNode, WhileNode, FunctionCallNode,
...
class TestSemanticAnalyzerWithInference:
    ...
    def test_analyze_variable_definition(self):
        ...
        var_def = VarDefNode(
            ...
            column=0,
            name="x",
            value=NumberNode(line=1, column=5, value=42)
        )
    ...
    def test_analyze_unary_operation(self):
        ...
        node = UnaryOpNode(
            ...
            column=0,
            op="-",
            operand=NumberNode(line=1, column=1, value=42)
        )
    ...
    def test_analyze_function_call(self):
        ...
        node = FunctionCallNode(
            ...
            column=0,
            name="打印",
            args=[StringNode(line=1, column=4, value="hello")]
        )
        ...
        node = IfNode(
            ...
            then_branch=[
                FunctionCallNode(
                    ...
                    column=4,
                    name="打印",
                    args=[StringNode(line=2, column=8, value="true")]
                )
            ],
            else_branch=None
        )
    ...
    def test_analyze_for_loop(self):
        ...
        node = ForNode(
            ...
            iterable=FunctionCallNode(
                ...
                column=8,
                name="范围",
                args=[NumberNode(line=1, column=13, value=10)]
            ),
            body=[
                FunctionCallNode(
                    line=2,
                    column=4,
                    name="打印",
                    args=[IdentifierNode(line=2, column=8, name="i")]
                )
            ]
        )
    ...
    def test_analyze_return_statement(self):
        ...
        node = ReturnNode(
            line=1,
            column=0,
            value=NumberNode(line=1, column=7, value=42)
        )
        ...
        node = BlockNode(
            ...
            statements=[
                VarDefNode(
                    ...
                    column=4,
                    name="x",
                    value=NumberNode(line=2, column=8, value=42)
                ),
                AssignNode(
                    line=3,
                    column=4,
        ...
        program = ProgramNode(
            statements=[
                ...
                VarDefNode(
                    ...
                    column=0,
                    name="y",
                    value=NumberNode(line=2, column=4, value=20)
                ),
                BinaryOpNode(
                    line=3,
                    column=0,
    ...
    def test_type_inference_for_variables(self):
        ...
        var_def = VarDefNode(
            ...
            column=0,
            name="x",
            value=NumberNode(line=1, column=4, value=42)
        )
        analyzer.analyze(var_def)
    ...
    def test_nested_scope(self):
        ...
        global_var = VarDefNode(
            ...
            column=0,
            name="global_var",
            value=NumberNode(line=1, column=12, value=100)
        )
    ...
    def test_error_recovery(self):
        ...
        valid = VarDefNode(
            ...
            column=0,
            name="x",
            value=NumberNode(line=2, column=4, value=42)
        )
