...
class TestMacroExpanderDetailed:
    ...
    def test_expand_ast_function_call_with_macro(self):
        ...
        # 注册一个简单的宏
        macro = Macro(
            name="测试宏", type=MacroType.SYNTAX, params=["参数"], body="打印 参数。", description="测试宏展开"
        )
        ...
        macro_call = FunctionCallNode(
            name="测试宏", args=[StringNode(value="你好", line=1, column=10)], line=1, column=1
        )
    ...
    def test_expand_ast_function_call_without_macro(self):
        ...
        func_call = FunctionCallNode(
            name="打印", args=[StringNode(value="测试", line=1, column=8)], line=1, column=1
        )
    ...
    def test_expand_ast_if_node(self):
        ...
        if_node = IfNode(
            ...
            then_branch=[
                FunctionCallNode(
                    name="打印", args=[StringNode(value="真值", line=2, column=7)], line=2, column=1
                )
            ],
            else_branch=[
                FunctionCallNode(
                    name="打印", args=[StringNode(value="假值", line=4, column=7)], line=4, column=1
                )
            ],
            line=1,
            column=1,
    ...
    def test_expand_ast_for_node_with_macro(self):
        ...
        for_node = ForNode(
            ...
            body=[
                FunctionCallNode(
                    name="处理", args=[IdentifierNode(name="元素", line=2, column=8)], line=2, column=1
                )
            ],
            line=1,
            column=1,
    ...
    def test_expand_ast_while_node(self):
        ...
        while_node = WhileNode(
            ...
            body=[FunctionCallNode(name="执行", args=[], line=2, column=1)],
            line=1,
            column=1,
        )
    ...
    def test_expand_macro_call_recursion_limit(self):
        ...
        # 创建递归宏调用
        macro_call = FunctionCallNode(
            name="递归宏", args=[NumberNode(value=100, line=1, column=10)], line=1, column=1
        )
