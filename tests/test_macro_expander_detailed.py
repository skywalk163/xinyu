...
class TestMacroExpanderDetailed:
    ...
    def test_expand_ast_if_node(self):
        ...
        if_node = IfNode(
            ...
            then_branch=[
                FunctionCallNode(name="打印", args=[StringNode(value="真值", line=2, column=7)], line=2, column=1)
            ],
            else_branch=[
                FunctionCallNode(name="打印", args=[StringNode(value="假值", line=4, column=7)], line=4, column=1)
            ],
            line=1,
            column=1
        )
